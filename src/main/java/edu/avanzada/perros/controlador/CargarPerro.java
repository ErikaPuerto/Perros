    ...
    private void cargarDatosDesdePropiedades() {
        ...
        for (String key : razasIniciales.keySet()) {
            ...
            if (!miControladorPerro.existePerro(id)) {
                ...
                PerroVO perroExistente = miPerroDAO.consultarPerro(id); // Consultamos el perro de la base de datos
                if (perroExistente != null) {
                    listaPerros.add(perroExistente);  // Agregamos el perro existente a la lista
